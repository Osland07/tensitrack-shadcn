...
interface WelcomeProps {
    canRegister?: boolean;
    faktorRisiko: FaktorRisiko[]; // New prop for dynamic questions
}

export default function Welcome({ canRegister = true, faktorRisiko }: WelcomeProps) {
    ...
    return (
        <>
            ...
            {/* Modal */}
            <ScreeningModal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} faktorRisiko={faktorRisiko} />
...
// Assign the layout
Welcome.layout = (page: React.ReactElement<PropsWithChildren<{ title?: string, canRegister?: boolean, faktorRisiko?: FaktorRisiko[] }>>) => {
    const { title, canRegister, faktorRisiko } = page.props; // Destructure faktorRisiko
    return <PublicLayout title={title} canRegister={canRegister} faktorRisiko={faktorRisiko} children={page} />;
};