                ...
                return (
                    ...
                    <div className="grid gap-4 p-6">
                        <Card>
                            ...
                            <CardContent>
                                <p><strong>Nama:</strong> {selectedScreeningData.user?.nama || 'N/A'}</p>
                        ...
                        <Card>
                            ...
                            <CardContent>
                                {selectedScreeningData.tingkat_risiko.length > 0 ? (
                                    <ul className="list-disc pl-5">
                                        {selectedScreeningData.tingkat_risiko.map((level, index) => (
                                            <li key={index}>
                                                <strong>{level.nama}:</strong> {level.keterangan}
                                            </li>
                                        ))}
                                    </ul>
                                ) : (
                        ...
                        <Card>
                            ...
                            <CardContent>
                                {selectedScreeningData.faktor_risiko.length > 0 ? (
                                    <ul className="list-disc pl-5 grid gap-2 md:grid-cols-2">
                                        {selectedScreeningData.faktor_risiko.map((factor, index) => (
                                            <li key={index}>
                                                <strong>{factor.nama} ({factor.kode}):</strong> {factor.pivot.value}
                                            </li>
                                        ))}
                                    </ul>
                                ) : (
                            ...
                            <TableBody>
                                {screenings.data.map((screening, index) => (
                                    <TableRow key={screening.id}>
                                        ...
                                        <TableCell className="text-center">{screening.user?.nama || 'N/A'}</TableCell>
