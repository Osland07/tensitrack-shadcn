...
class RiskLevelController extends Controller
{
    ...
    {
        return Inertia::render('admin/risk-levels-create');
    }

    public function edit(RiskLevel $riskLevel): Response
    {
        return Inertia::render('admin/risk-levels-edit', [
            'riskLevel' => $riskLevel,
        ]);
    }
            ...
            public function index(Request $request): Response
            {
                ...
                return Inertia::render('admin/risk-levels', [
            ...
            }    public function store(StoreRiskLevelRequest $request): RedirectResponse
    {
        ...
        return to_route('risk-levels.index')->with('success', 'Data berhasil disimpan!');
    }
